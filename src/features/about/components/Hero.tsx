...
export function Hero() {
  return (
    <section className="min-h-[80vh] lg:min-h-screen border-b border-border flex items-center px-6 md:px-20 py-15 overflow-hidden animate-fade-in-up">
      <div className="w-full flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
        <div className="max-w-3xl">
          <span className="font-sans text-sm font-bold text-primary tracking-[0.25em] uppercase mb-6 block animate-fade-in-up animation-delay-100">
            Welcome to VERIS
          </span>
        ...
        <div className="w-full lg:flex-1 lg:h-full flex flex-col items-center justify-center gap-6 lg:max-w-md">
          <BlobCard
            title="Our Mission"
          ...
          <BlobCard
            ...
            className="lg:ml-10 animate-fade-in-up animation-delay-600"
          />
        </div>
      </div>
    </section>
