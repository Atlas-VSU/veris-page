...
export function SubscriptionTierCard({ tier }: SubscriptionTierCardProps) {
  ...
  return (
    <div
      className={`relative flex flex-col p-8 border transition-all duration-500 group overflow-hidden ${tier.organicClass
        } ${isPremium
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-baseline justify-between gap-2 mb-1">
          <h3
            className={`text-4xl font-extrabold tracking-tight font-serif ${isPremium ? "text-[#FDFCF8]" : "text-[#2C2C24]"
              }`}
          >
            {tier.name}
          </h3>
          <span
            className={`text-xs font-semibold whitespace-nowrap ${isPremium ? "text-[#DED8CF]" : "text-[#78786C]"
              }`}
          >
            {tier.orgLimit}
          </span>
        ...
        {/* Tagline */}
        <p
          className={`text-sm font-medium ${isPremium ? "text-[#DED8CF]" : "text-[#78786C]"
            }`}
        >
          {tier.tagline}
        </p>
        ...
        <div className="mt-6 flex items-baseline gap-1">
          <span
            className={`text-5xl font-black font-serif tracking-tight ${isPremium ? "text-[#FDFCF8]" : isPlus ? "text-[#C18C5D]" : "text-[#5D7052]"
              }`}
          >
            {tier.rate}
          </span>
        ...
        <div
          className={`mt-2 text-xs font-mono tracking-wide ${isPremium ? "text-[#DED8CF]/70" : "text-[#78786C]"
            }`}
        >
          {tier.minimumNote}
        </div>
